...
<section id="blog" class="container">
    <div class="row">
        ...
        <div class="col-sm-8 col-sm-pull-4">
            <div class="blog">
                <div class="blog-item">
                    <img class="img-responsive img-blog" src="statics/images/blog/blog1.jpg" width="100%" alt="" />
                ...
                <div class="blog-item">
                    ...
                    <div class="blog-content">
                        <a href="<?= Url::to(['blog-item'])?>"><h3>Conubia nostra per inceptos himenaeos</h3></a>
                        <div class="entry-meta">
                            <span><i class="icon-user"></i> <a href="#">John</a></span>
                            <span><i class="icon-folder-close"></i> <a href="#">Bootstrap</a></span>
                            <span><i class="icon-calendar"></i> Sept 16th, 2012</span>
