    ...
    <div class="row">
        <aside class="col-sm-4 col-sm-push-8">
            ...
            <div class="widget ads">
                <div class="row">
                    <div class="col-xs-6">
                        <a href="#"><img class="img-responsive img-rounded" src="statics/images/ads/ad1.png" alt=""></a>
                    </div>

                    <div class="col-xs-6">
                        <a href="#"><img class="img-responsive img-rounded" src="statics/images/ads/ad2.png" alt=""></a>
                    </div>
                </div>
                <p> </p>
                <div class="row">
                    <div class="col-xs-6">
                        <a href="#"><img class="img-responsive img-rounded" src="statics/images/ads/ad3.png" alt=""></a>
                    </div>

                    <div class="col-xs-6">
                        <a href="#"><img class="img-responsive img-rounded" src="statics/images/ads/ad4.png" alt=""></a>
                    </div>
                </div>
            </div><!--/.ads-->
        ...
        <div class="col-sm-8 col-sm-pull-4">
            <div class="blog">
                <div class="blog-item">
                    <img class="img-responsive img-blog" src="statics/images/blog/blog2.jpg" width="100%" alt="" />
                    <div class="blog-content">
                        ...
                        <div class="author well">
                            <div class="media">
                                <div class="pull-left">
                                    <img class="avatar img-thumbnail" src="statics/images/blog/avatar.jpg" alt="">
                                </div>
                        ...
                        <div id="comments">
                            <div id="comments-list">
                                ...
                                <div class="media">
                                    <div class="pull-left">
                                        <img class="avatar img-circle" src="statics/images/blog/avatar1.png" alt="">
                                    </div>
                                    <div class="media-body">
                                        <div class="well">
                                            <div class="media-heading">
                                        ...
                                        <div class="media">
                                            <div class="pull-left">
                                                <img class="avatar img-circle" src="statics/images/blog/avatar3.png" alt="">
                                            </div>
                                            <div class="media-body">
                                                <div class="well">
                                                    <div class="media-heading">
                                ...
                                <div class="media">
                                    <div class="pull-left">
                                        <img class="avatar img-circle" src="statics/images/blog/avatar2.png" alt="">
                                    </div>
                                    <div class="media-body">
                                        <div class="well">
                                            <div class="media-heading">
